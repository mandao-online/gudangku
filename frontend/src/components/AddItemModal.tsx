...
interface AddItemModalProps {
  open: boolean;
  onClose: () => void;
  onConfirm: (itemData: FormData) => void;
}

export function AddItemModal({ open, onClose, onConfirm }: AddItemModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.sku || !formData.unit || !formData.category) {
      return;
    }
      ...
      <DialogContent className="max-w-md mx-auto max-h-[90vh] overflow-y-auto">
        ...
        {imagePreview && (
          <ImageZoomModal
            ...
            imageName="Preview Gambar Barang"
            imageAlt="Preview gambar barang baru"
          />
        )}
